...
const I18N = (() => {
  const dict = {
    ru: {
      ...
      limit: 'Фигур у каждого', limitHint: 'от 3 до 4 на поле 3×3',
      fewer: 'Меньше фигур', more: 'Больше фигур',
    ...
    en: {
      ...
      limit: 'Pieces per player', limitHint: '3 to 4 on a 3×3 board',
      fewer: 'Fewer pieces', more: 'More pieces',
    ...
    th: {
      ...
      limit: 'จำนวนตัวต่อผู้เล่น', limitHint: '3 ถึง 4 ตัวบนกระดาน 3×3',
      fewer: 'ลดจำนวนตัว', more: 'เพิ่มจำนวนตัว',
